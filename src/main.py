...
from functions import loadCsv, preElaborationData, removeColumns, printHistogram, stratifiedKFold, decisionTreeLearner, \
    showTree, assign_class_to_cluster, dataScaler, elbowMethod
...
computeConfusionMatrix(yTest, yPred, bestTree)
...
# 2step: Elbow method
# The lower is the inertia, the better is the clustering operation
kmLabels = elbowMethod(Xscaled)


#  assign_class_to_cluster
clusters, class_to_cluster, purity = assign_class_to_cluster(y, kmLabels)
